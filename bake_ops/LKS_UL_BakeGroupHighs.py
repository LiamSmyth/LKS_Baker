"""UIList of high-role objects in the active bake group."""
...
class LKS_UL_BakeGroupHighs(bpy.types.UIList):
    """Object names for all high-role collections in the active bake group."""

    bl_idname = 'LKS_UL_BakeGroupHighs'
    ...
    def _objects(
        ...
        if project is None:
            return []
        return iter_bake_group_high_objects(project, bake_group)
