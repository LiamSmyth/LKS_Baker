"""Create a bake group from eligible selection and move objects into `{stem}/`."""
...
class LKS_OT_AddSelectionToBakeGroup(bpy.types.Operator):
    """Create a bake group from selection and move objects into its staging folder."""
    bl_idname = 'object.lks_add_selection_to_bake_group'
